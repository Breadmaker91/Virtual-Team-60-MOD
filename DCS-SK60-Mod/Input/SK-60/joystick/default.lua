...
keyCommands = {
	...
	{down = Keys.PilotTintedVisorToggle, name = _('Toggle Tinted Visor'), category = _('View Cockpit')},
    ...
    {down = iCommandPlaneFlaps,					name = _('Flaps Step Toggle'),				category = _('Systems')},
    ...
    {down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButton, name = _('Nose Wheel Steering'), category = _('Systems')},
   ...
   -- {down = iCommandPlaneFSQuantityIndicatorSelectorINT,	up = iCommandPlaneFSQuantityIndicatorSelectorINT, value_down = -1, value_up = 0, 	name = _('Bingo Fuel Index, CCW'), category = _('Systems')},
    ...
    {down = Keys.WeaponFireOn, up = Keys.WeaponFireOff,	name = _('Trigger'),		category = _('Weapons')},
    {down = Keys.WeaponSafetyTrigger, name = _('Weapon Safety Trigger Toggle'), category = _('Weapons')},
    {down = Keys.WeaponSafetyTriggerOn, value_down = 1, name = _('Weapon Safety Trigger ARMED'), category = _('Weapons')},
    {down = Keys.WeaponSafetyTriggerOn, value_down = 0, name = _('Weapon Safety Trigger SAFE'), category = _('Weapons')},

    --HOTAS
    {down = Keys.Flap_Pos_Up,	up = Keys.Flap_Pos_Half,			name = _('HOTAS Flaps Retracted/Takeoff'),					category = _('HOTAS') },
    {down = Keys.Flap_Pos_Down,	up = Keys.Flap_Pos_Half,			name = _('HOTAS Flap Landing/Takeoff'),				category = _('HOTAS') },
    ...
    {down = Keys.Nav_RNAV_PWR, value_down = -0.1, name = _('RNAV Display Power OFF'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_DAT_CYCLE, value_down = 1, name = _('RNAV Data Segment Select'), category = _('NAV Unit')},
    {down = Keys.Nav_Right_Knob_L, value_down = 0.1, name = _('RNAV Encoder Knob Outer Increase'), category = _('NAV Unit')},
    {down = Keys.Nav_Right_Knob_L, value_down = -0.1, name = _('RNAV Encoder Knob Outer Decrease'), category = _('NAV Unit')},
    {down = Keys.Nav_Right_Knob_S, value_down = 0.1, name = _('RNAV Encoder Knob Inner Increase'), category = _('NAV Unit')},
    {down = Keys.Nav_Right_Knob_S, value_down = -0.1, name = _('RNAV Encoder Knob Inner Decrease'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_WPT_CYCLE, value_down = 0.1, name = _('RNAV Waypoint Next'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_WPT_CYCLE, value_down = -0.1, name = _('RNAV Waypoint Previous'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_USE, value_down = 1, name = _('RNAV USE Button'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_RTN, value_down = 1, name = _('RNAV RTN Button'), category = _('NAV Unit')},
    {down = Keys.Nav_RNAV_CHK_PRESS, up = Keys.Nav_RNAV_CHK_RELEASE, value_down = 1, value_up = 0, name = _('RNAV CHK Button'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_100, value_down = 0.1, name = _('ADF Frequency 100 kHz Increase'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_100, value_down = -0.1, name = _('ADF Frequency 100 kHz Decrease'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_1, value_down = 0.1, name = _('ADF Frequency 1 kHz Increase'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_1, value_down = -0.1, name = _('ADF Frequency 1 kHz Decrease'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_PWR, value_down = 0.1, name = _('ADF Display Power ON'), category = _('NAV Unit')},
    {down = Keys.Nav_ADF_PWR, value_down = -0.1, name = _('ADF Display Power OFF'), category = _('NAV Unit')},
    {down = Keys.Nav_DME_PWR_ON, value_down = 1, name = _('DME Display Power ON'), category = _('NAV Unit')},
...
axisCommands = {
    ...
    {action = iCommandLeftWheelBrake,	name = _('Wheel Brake Right')},
    {action = iCommandRightWheelBrake,	name = _('Wheel Brake Left')},
