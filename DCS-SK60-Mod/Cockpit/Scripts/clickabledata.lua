...
multi_tumb_click_list = {
 ...
 --  {"PTN_128", "Tail Navigation Light", devices.LIGHT_SYSTEM, 128, nil, Keys.LightNaviTailUP, Keys.LightNaviTailDOWN},
   ...
   -- FR31 radio
    ...
    {"PTN_553", "FR31 BAS Preset Mode", devices.FR31_RADIO, 553, nil, Keys.FR31_BAS_Mode},
   ...
   -- FR31 numeric frequency keypad
    {"PTN_542", "FR31 Key 1/A", devices.FR31_RADIO, 542, nil, Keys.FR31_Key_1},
    {"PTN_543", "FR31 Key 2/B", devices.FR31_RADIO, 543, nil, Keys.FR31_Key_2},
    {"PTN_544", "FR31 Key 3/C", devices.FR31_RADIO, 544, nil, Keys.FR31_Key_3},
    {"PTN_545", "FR31 Key 4/C2", devices.FR31_RADIO, 545, nil, Keys.FR31_Key_4},
    {"PTN_546", "FR31 Key 5/D", devices.FR31_RADIO, 546, nil, Keys.FR31_Key_5},
...
local fr31_keypad_buttons = {
    ...
    {"PTN_553", "FR31 BAS Preset Mode", Keys.FR31_BAS_Mode, 553},
    {"PTN_712", "FR31 NR Mode", Keys.FR31_NR_Mode, 712},
    {"PTN_715", "FR31 Clear", Keys.FR31_Clear, 715},
    {"PTN_542", "FR31 Key 1/A", Keys.FR31_Key_1, 542},
    {"PTN_543", "FR31 Key 2/B", Keys.FR31_Key_2, 543},
    {"PTN_544", "FR31 Key 3/C", Keys.FR31_Key_3, 544},
    {"PTN_545", "FR31 Key 4/C2", Keys.FR31_Key_4, 545},
    {"PTN_546", "FR31 Key 5/D", Keys.FR31_Key_5, 546},
...
-- PTN_751 is the clickable mouse-wheel connector; nav_system.lua drives the selected heading indicator on arg 753.
